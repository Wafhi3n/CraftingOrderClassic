...
local news = {
    ...
    ["Un nouveau bouton « i » ouvre l'aide contextuelle du jeu, le même système que Blizzard utilise pour ses propres fenêtres : le fond s'assombrit et une bulle pointe directement sur ce dont il est question. Chaque onglet (Vue Métier, Commande, Récolte, Artisans, Mes artisans, Carnet) a sa propre visite guidée, donc le bouton explique ce qui est réellement affiché plutôt qu'une infobulle générique."] =
        "Ein neuer „i\"-Knopf öffnet die Kontexthilfe des Spiels, dasselbe System, das Blizzard für seine eigenen Fenster nutzt: der Hintergrund verdunkelt sich, und eine Sprechblase zeigt direkt auf das Element, um das es geht. Jeder Reiter (Berufsansicht, Auftrag, Sammeln, Handwerker, Meine Handwerker, Kontobuch) hat seine eigene Führung, sodass der Knopf erklärt, was tatsächlich zu sehen ist, statt eines allgemeinen Tooltips.",
    ["Lazy Gold et MTSL restent optionnels, mais rien ne signalait qu'ils manquaient. Les boutons qui en dépendent restent visibles et colorés même sans l'addon installé, et cliquer dessus sans l'avoir ouvre désormais une explication de ce qu'il fait et où le trouver, plutôt que de ne rien faire du tout."] =
        "Lazy Gold und MTSL bleiben optional, aber nichts zeigte an, wenn eines von beiden fehlte. Die Knöpfe, die sie brauchen, bleiben sichtbar und farbig, ob das Addon installiert ist oder nicht, und ein Klick ohne das Addon öffnet jetzt eine kurze Erklärung, was es tut und wo man es bekommt, statt nichts zu tun.",
    ["L'alerte « peut faire cette commande » se déclenchait même quand tu ne connaissais pas la recette, souvent des gemmes ou enchants dont tu avais les réactifs sans le plan. Elle vérifie maintenant tes recettes connues avant de te notifier sur tes propres commandes. Un ami en ligne sans l'addon ne s'affiche plus « Hors ligne » par erreur."] =
        "Der Hinweis „kann das herstellen\" löste auch aus, wenn du das Rezept gar nicht kanntest, meist Schmucksteine oder Verzauberungen, für die du die Reagenzien, aber nicht den Plan hattest. Er prüft jetzt deine bekannten Rezepte, bevor er dich wegen deiner eigenen Aufträge nervt. Ein Freund, der ohne Addon online ist, wird nicht mehr fälschlich als offline angezeigt.",
    ["Échap laissait souvent les fenêtres de métier ouvertes, et trois rapports différents pointaient la même cause : cacher ou désactiver la souris d'une fenêtre protégée en plein combat déclenche une erreur du jeu. Les fenêtres passent maintenant par un petit relais dédié, donc Échap les ferme proprement, en combat ou non."] =
        "Escape ließ Berufsfenster meistens offen, und drei getrennte Fehlerberichte zeigten auf dieselbe Ursache: ein geschütztes Fenster mitten im Kampf zu verstecken oder seine Maus zu deaktivieren, löst einen Spielfehler aus. Fenster laufen jetzt stattdessen über ein kleines Relais, sodass Escape sie sauber schließt, im Kampf oder nicht.",
    ["L'aide « quoi monter ensuite » affiche maintenant le coût par point de compétence, une pastille de prix Auctioneer, et une icône vers le PNJ qui vend une recette que tu ne connais pas encore, en plus d'un tri affiné."] =
        "Die Hilfe „was als Nächstes hochziehen\" zeigt jetzt die Kosten pro Fertigkeitspunkt, ein Auctioneer-Preisabzeichen und ein Symbol zum Händler, der ein Rezept verkauft, das du noch nicht kennst, dazu eine feinere Sortierung.",
    ["Cette même aide gagne un plan de route : clique le bouton carte et il déroule toute ta montée rang par rang, en choisissant à chaque étape la recette la moins chère (apprise ou achetable, plans compris) et en additionnant le coût total. Les recettes à cooldown ou avec un réactif sans prix connu sont exclues exprès, elles fausseraient le total. Demande Lazy Gold ; MTSL ajoute les prix de plans formateur et vendeur au calcul."] =
        "Dieselbe Hilfe bekommt jetzt einen Routenplaner: Klick den Kartenknopf, und er rechnet deinen ganzen Aufstieg Rang für Rang durch, wählt bei jedem Schritt das günstigste Rezept (gelernt oder kaufbar, Pläne eingeschlossen) und summiert die Gesamtkosten. Rezepte mit Abklingzeit oder einer Zutat ohne bekannten Preis werden absichtlich ausgeschlossen, sie würden die Summe verfälschen. Braucht Lazy Gold; MTSL fügt Händler- und Verkäuferpreise für Pläne hinzu.",
    -- v1.21.0
    ["L'enchant par emplacement, et un panneau d'échange qui ne cache plus rien"] =
        "Verzauberungen nach Platz, und ein Tauschfenster, das nichts mehr versteckt",
    ["Choisir un enchant demandait de fouiller des centaines de plans aux noms presque identiques. L'onglet Commande a maintenant une vue silhouette : clique l'emplacement à enchanter, tu obtiens ses stats, puis ses variantes de la plus forte à la plus faible. La bascule est dans la bande de filtres ; la liste reste pour tout ce qui n'a pas d'emplacement (huiles, baguettes, produits de désenchantement)."] =
        "Eine Verzauberung auszuwählen hieß, sich durch Hunderte fast gleich benannter Rezepte zu scrollen. Der Auftrag-Reiter hat jetzt eine Silhouetten-Ansicht: Klick auf den Platz, den du verzaubern willst, und du bekommst dessen Werte und dann die Varianten von stark nach schwach. Der Umschalter sitzt in der Filterleiste; die Rezeptliste bleibt für alles ohne Platz (Öle, Zauberstäbe, Entzauberungsmaterial).",
    ["Le panneau d'enchant de l'échange n'affichait que 8 lignes, et le « +N autre(s) » du bas n'était pas cliquable : au-delà de la 8ᵉ place, un enchant était tout bonnement inatteignable — c'est ainsi qu'un enchanteur à qui on avait passé les réactifs ne se voyait jamais proposer la bonne recette, noyée sous les variantes de haut rang. La liste défile à la molette, et elle est classée par ce qu'on te demande : d'abord les enchants dont ton partenaire vient de poser les réactifs, puis ce que tes sacs permettent, puis le reste."] =
        "Das Verzauberungsfenster beim Tauschen zeigte nur 8 Zeilen, und das „+N weitere\" unten war nicht anklickbar: ab dem neunten Eintrag war eine Verzauberung schlicht unerreichbar. So bekam ein Verzauberer, dem man die Reagenzien gereicht hatte, das richtige Rezept nie angeboten, begraben unter Varianten höheren Rangs. Die Liste scrollt jetzt mit dem Mausrad und ist danach sortiert, worum du gebeten wirst: zuerst die Verzauberungen, deren Reagenzien dein Partner gerade auf den Tisch gelegt hat, dann was deine Taschen schon hergeben, dann der Rest.",
    ["Tant que la case « ne sera pas échangé » est vide, le panneau ne disparaît plus : il montre la même silhouette, avec le modèle de ton partenaire, et cliquer un emplacement lui chuchote d'y poser cette pièce. La plupart des gens qui te tendent un objet ignorent que cette case existe."] =
        "Solange der Platz „Wird nicht gehandelt\" leer ist, verschwindet das Fenster nicht mehr: Es zeigt dieselbe Silhouette, mit dem Modell deines Tauschpartners darin, und ein Klick auf einen Platz flüstert ihm zu, das Teil dort hineinzulegen. Die meisten, die dir Ausrüstung reichen, wissen gar nicht, dass es diesen Platz gibt.",
