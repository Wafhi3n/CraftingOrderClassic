...
local de2 = {
    ...
    ["Livre de rang"] = "Rangbuch",
    ["Entraîne le rang supérieur chez ton formateur de métier."] = "Erlerne den nächsten Rang bei deinem Berufslehrer.",
    ["Formateur : %s"] = "Lehrer: %s",
    ...
    ["Clic : poser un repère sur ce PNJ."] = "Klick: setzt eine Wegmarke auf diesen NSC.",
    ...
    ["Installe Auctionator pour voir les prix."] = "Installiere Auctionator, um Preise zu sehen.",
    ...
    ["Aucune source connue de ton camp."] = "Keine Quelle auf deiner Seite bekannt.",
