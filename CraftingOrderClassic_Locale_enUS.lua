...
local en = {
    ...
    ["Si elle s'ouvre sur un autre métier, clique à nouveau."] = "If it opens on another profession, click again.",
    ["Clic : ouvrir cette fenêtre de métier."] = "Click: open that profession window.",
    ["Ouvre ta fenêtre d'Enchantement."] = "Open your Enchanting window.",
    ...
    ["Rien de posé. Clique un emplacement pour lui demander sa pièce."] = "Nothing placed yet. Click a slot to ask them for that item.",
