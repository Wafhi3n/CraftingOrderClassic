...
local de = {
    -- Benachrichtigung « neue Version verfügbar » (Directory_Version / Minimap / /co version)
    ...
    ["Si elle s'ouvre sur un autre métier, clique à nouveau."] = "Öffnet sie sich auf einem anderen Beruf, klicke erneut.",
    ["Clic : ouvrir cette fenêtre de métier."] = "Klick: dieses Berufsfenster öffnen.",
    ["Ouvre ta fenêtre d'Enchantement."] = "Öffne dein Verzauberkunst-Fenster.",
    ...
    ["Rien de posé. Clique un emplacement pour lui demander sa pièce."] = "Noch nichts abgelegt. Klicke auf einen Platz, um diesen Gegenstand anzufragen.",
