...
local es = {
    ...
    ["Si elle s'ouvre sur un autre métier, clique à nouveau."] = "Si se abre en otra profesión, haz clic de nuevo.",
    ["Clic : ouvrir cette fenêtre de métier."] = "Clic: abrir esa ventana de profesión.",
    ["Ouvre ta fenêtre d'Enchantement."] = "Abre tu ventana de Encantamiento.",
